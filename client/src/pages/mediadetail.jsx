        ...
        <div className="relative w-full h-[500px] md:h-[700px] lg:h-[824px] overflow-hidden">
          ...
          <div className="relative h-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[70px] flex flex-col justify-end pb-12 md:pb-20">
            ...
            <div className="flex flex-wrap items-center gap-3 md:gap-4">
              <button
                onClick={openTrailer}
                className="px-4 md:px-6 py-2 md:py-2.5 bg-coquelicot text-white text-sm md:text-base lg:text-[18px] font-semibold rounded-lg hover:bg-coquelicot/90 transition-colors"
              >
                Watch trailer
              </button>
              <button
              ...
              {homepage && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 md:px-6 py-2 md:py-2.5 border border-white text-white text-sm md:text-base lg:text-[18px] rounded-lg hover:bg-white/10 transition-colors"
                >
                  Official site
                </a>
              )}
