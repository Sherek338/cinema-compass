        ...
        const mapped = (json.results || [])
          ...
          .map((r) => {
            ...
            return {
              ...
              title: r.title,
              name: r.name,
              poster: r.poster_path ? `https://image.tmdb.org/t/p/w500${r.poster_path}` : "https://via.placeholder.com/400x600?text=No+Image",
  ...
  return (
    <div className="min-h-screen bg-[#201E1F] flex flex-col">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 sm:px-6 lg:px-[70px] py-16">
        <h1 className="text-white font-bold text-[35px] mb-8">Search results</h1>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
            {results.map((r) => (
              <MediaCard key={`${r.isSeries ? "tv" : "movie"}-${r.id}`} {...r} />
            ))}
          </div>
        )}
      </main>
